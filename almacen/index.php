                               ...
                               <table id="example1" class="table table-bordered table-striped table-sm">
                                   ...
                                   ?>
                                       <tr>
                                           ...
                                           <td>
                                               <center><img src="<?php echo $URL."/almacen/img_productos/".$productos_dato['imagen'];?>" width="60px" alt="Producto"></center>
                                           </td>
                                           <td><?php echo $productos_dato['codigo'];?></td>
                                           <td><?php echo $productos_dato['nombre'];?></td>
                                           <td><?php echo $productos_dato['cantidad'].' '.$productos_dato['unidad']; ?></td>
                                           ...
                                           if($stock_actual < $stock_minimo){ ?>
                                               <td style="background-color: #ee868b"><center><?php echo $stock_actual; ?></center></td>
                                           <?php } elseif($stock_actual > $stock_maximo){ ?>
                                               <td style="background-color: #8ac68d"><center><?php echo $stock_actual; ?></center></td>
                                           <?php }else{ ?>
                                               <td><center><?php echo $stock_actual; ?></center></td>
                                           <?php } ?>
